...
public class ForgetPasswordTest(CustomWebApplicationFactory factory) : IAsyncLifetime
{
    ...
    public async Task ForgetPassword_Should_ReturnSuccess_When_DataIsValid()
    {
        ...
        emailConfirmationCodeDb.CodeHash.ShouldNotBe(emailConfirmationCodeHasher.Hash(PlainCode));
