...
public class ReviewCreatedUpdateProductReviewEventHandler(
    IProductRepository productRepository,
    IUnitOfWork unitOfWork,
    ICacheService cacheService) : IDomainEventHandler<ReviewCreatedEvent>
{
    public async Task Handle(ReviewCreatedEvent domainEvent, CancellationToken cancellationToken = default)
    {
        ...
        product.AddReviewVote(domainEvent.Rating);
