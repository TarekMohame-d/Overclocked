...
public class ReviewDeletedUpdateProductReviewEventHandler(
    ...
    ICacheService cacheService) : IDomainEventHandler<ReviewDeletedEvent>
{
    public async Task Handle(ReviewDeletedEvent domainEvent, CancellationToken cancellationToken = default)
    {
