...
public class DeleteReviewReplyTest(CustomWebApplicationFactory factory) : IAsyncLifetime
{
    ...
    public async Task Delete_Should_DeleteAndReturnSuccess_When_DataIsValid()
    {
        ...
        HttpResponseMessage response = await _client
            .DeleteAsync(ReviewReplyRoutes.Delete.Replace("{productId:guid}", product.Id.Value.ToString()).Replace("{reviewId:guid}", review.Id.Value.ToString()).Replace("{replyId:guid}", review.ReviewReply!.Id.Value.ToString()));
