...
public class ConfirmEmailTest(CustomWebApplicationFactory factory) : IAsyncLifetime
{
    ...
    public async Task ConfirmEmail_Should_ReturnSuccess_When_DataIsValid()
    {
        ...
        User? userDb = await dbContext.Users.Include(u => u.EmailConfirmationCode)
        ...
        IDomainEventHandler<UserEmailConfirmedEvent> handler = scope.ServiceProvider
            .GetRequiredService<IDomainEventHandler<UserEmailConfirmedEvent>>();
