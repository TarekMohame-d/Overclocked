...
public class GetRatingBreakDownTest(CustomWebApplicationFactory factory) : IAsyncLifetime
{
    ...
    public async Task GetRatingBreakDown_Should_ReturnSuccess_When_DataIsValid()
    {
        ...
        HttpResponseMessage response = await _client
            .GetAsync(ReviewRoutes.GetReviewsRatingBreakdown.Replace("{productId:guid}", product.Id.Value.ToString()));
