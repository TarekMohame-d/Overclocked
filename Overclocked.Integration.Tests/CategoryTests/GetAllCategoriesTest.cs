...
public class GetAllCategorysTest(CustomWebApplicationFactory factory) : IAsyncLifetime
{
    ...
    public async Task GetAll_Should_ReturnFromDatabase_When_ThereIsDataAndCacheMiss()
    {
        ...
        IEnumerable<CategoryListResponse>? result =
            await response.Content.ReadFromJsonAsync<IEnumerable<CategoryListResponse>>();
    ...
    private async Task<IEnumerable<CategoryListResponse>> SeedCacheAsync()
    {
        ...
        IEnumerable<CategoryListResponse> categoryListResponses = categorys.ToDto();
