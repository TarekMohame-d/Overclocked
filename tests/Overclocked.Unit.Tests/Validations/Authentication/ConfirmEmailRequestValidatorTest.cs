...
{
    [Theory]
    [MemberData(nameof(ConfirmEmailValidationTestCases.InvalidEmailCases), MemberType = typeof(ConfirmEmailValidationTestCases))]
    public void ConfirmEmailRequestValidator_Should_ReturnError_When_EmailIsInvalid(string? email)
    {
        ...
        var request = new ConfirmEmailRequest { Email = email!, Code = "VC74A1" };
    ...
    [Theory]
    [MemberData(nameof(ConfirmEmailValidationTestCases.InvalidCodeCases), MemberType = typeof(ConfirmEmailValidationTestCases))]
    public void ConfirmEmailRequestValidator_Should_ReturnError_When_CodeIsInvalid(string? code)
    {
        // Arrange
        var validator = new ConfirmEmailRequestValidator();
        var request = new ConfirmEmailRequest { Email = "email@gmail.com", Code = code! };
