...
{
    public async Task<Result<IEnumerable<BrandListResponse>>> GetAllBrandsAsync(GetAllBrandsRequest request,
        CancellationToken cancellationToken)
    {
        IEnumerable<BrandListResponse> result = [];
        IEnumerable<Domain.Entities.Brand> brands =
            await brandRepository.GetAllAsync(cancellationToken: cancellationToken);
